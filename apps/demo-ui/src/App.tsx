...
const footerShortcuts = [
  {
    title: "국민소통채널",
    items: ["혁신24", "전자가족관계등록시스템", "국민재난안전포털", "문서24", "소통24", "찾기쉬운 생활법령정보", "안전 Dream", "정보공개", "적극행정", "국민신문고", "안전신문고", "KOSIS", "공유누리", "청렴포털", "소비자24", "정책브리핑", "복지로", "119·129", "고용복지센터", "국민연금", "정부업무평가포털"]
  },
  {
    title: "디지털증명",
    items: ["전자증명서", "공공 마이데이터", "모바일 신분증", "다운로드파일 진본확인", "정부24 전자문서지갑", "민원서류 발급", "보조금24", "국민비서 구삐"]
  },
  {
    title: "부가서비스",
    items: ["무인민원발급", "어디서나민원", "돌봄시설 위치 찾기", "내 주변 서비스", "행정서식 간편이름", "사실/진위확인", "기업/단체 서비스", "정부24 안내지도"]
  }
];
          ...
          <section className="footer-agency-info" aria-label="정부24 안내">
            <div className="footer-contact-block">
              ...
              <dl>
                <div>
                  <dt>콜센터</dt>
                  <dd>1588-2188, 02-721-0600 (지역번호 '02'를 확인하세요.) (09:00 ~ 18:00 평일)</dd>
                </div>
                <div>
                  <dt>정부민원안내콜센터</dt>
                  <dd>국번없이 110 (무료, 휴일포함 365일 24시간)</dd>
                </div>
                <div>
                  <dt>내선번호</dt>
                  <dd>
                    <span>1번 주민등록표 등본(초본), 건축물대장, 토지대장</span>
                    <span>2번 민원신청 및 발급문의</span>
                    <span>3번 혜택알리미, 디지털지갑(내지갑) 이용방법 문의</span>
                    <span>4번 회원가입 및 로그인 문의</span>
                  </dd>
                </div>
              </dl>
            </div>
            <nav className="footer-support-links" aria-label="정부24 지원 링크">
              {["찾아오시는 길", "상담예약", "원격지원", "누리집 의견 수렴", "공공서비스 활용(Open API)"].map((label) => (
                <button key={label} onClick={() => onOpenDetail(label)} type="button">{label}</button>
              ))}
            </nav>
          </section>
        )}
...
function footerShortcutDescription(label: string) {
  const descriptions: Record<string, string> = {
    "혁신24": "정부혁신 지식정보 포털",
    "전자가족관계등록시스템": "대한민국 법원 가족관계 증명",
    "국민재난안전포털": "재난 안전 정보와 행동 요령",
    "문서24": "공문서 제출과 문서 유통",
    "소통24": "국민 참여와 정책 소통",
    "찾기쉬운 생활법령정보": "생활 분야별 법령 안내",
    "안전 Dream": "아동·여성·장애인 경찰지원",
    "정보공개": "공공기관 정보공개 청구",
    "적극행정": "적극행정 사례와 제도 안내",
    "국민신문고": "민원·제안·정책참여 접수",
    "안전신문고": "생활 안전 위험 신고",
    ...
    "다운로드파일 진본확인": "발급 파일 위변조 여부 확인",
    "정부24 전자문서지갑": "전자문서 수신과 보관",
    "민원서류 발급": "주요 증명서 신청과 출력",
    "보조금24": "나에게 맞는 혜택 확인",
    "무인민원발급": "무인 발급기 위치와 이용 안내",
    "어디서나민원": "방문 수령 민원 신청",
    "돌봄시설 위치 찾기": "주변 돌봄시설 위치 검색",
    "내 주변 서비스": "위치 기반 공공서비스 탐색",
    "행정서식 간편이름": "혼동되는 서식 명칭 확인",
    "사실/진위확인": "증명서 진위 여부 확인",
    "기업/단체 서비스": "사업자·기관 대상 서비스",
    "정부24 안내지도": "서비스 메뉴와 경로 안내"
  };
